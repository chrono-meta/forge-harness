...
description: Verification that KP-SASE-blocked capabilities work correctly on personal network — install-wizard dry-run, plugin-recommender live GitHub search, frontier-digest fetch, git push.
...
> Part of meta-validation Wave 3. All items below were previously blocked or unverifiable in corporate (KP-SASE) environment.
...
**Status**: ✅ github.com live results returned — was blocked by KP-SASE in corporate environment
...
Corporate environment required REST API workaround (KP-SASE blocked TCP push to github.com:443).
...
| Capability | Corporate (KP-SASE) | External (personal) |
|---|---|---|
